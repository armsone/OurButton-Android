...
import com.armsone.ourbutton.platform.AndroidHardwareGateway
import com.armsone.ourbutton.state.AppViewModel
import com.armsone.ourbutton.ui.OurButtonApp
...
class MainActivity : ComponentActivity() {
    ...
    private fun handlePendingWidgetAction() {
        ...
        if (state.phase != com.armsone.ourbutton.state.AppPhase.HOME) {
