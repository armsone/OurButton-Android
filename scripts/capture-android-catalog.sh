...
if [[ -n "${BUTTON_FIXTURES:-}" ]]; then
  ...
  fixtures=(
    ...
    parent_home_voice_recording parent_home_voice_ready parent_home_voice_sent parent_home_siren_countdown
    ...
    voice_requesting voice_recording voice_ready voice_denied voice_sent incoming_quiet
