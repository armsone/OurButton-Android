...
if [[ -n "${BUTTON_FIXTURES:-}" ]]; then
  ...
  fixtures=(
    ...
    role_selection parent_home parent_home_targeted parent_home_sent parent_home_ack parent_home_demo parent_home_idle
    parent_home_searching child_home child_home_targeted child_home_sent child_home_ack child_home_demo invite_qr voice_idle
