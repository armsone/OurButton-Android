...
fixtures=(
  ...
  role_selection parent_home parent_home_ack parent_home_demo parent_home_idle
  parent_home_searching child_home child_home_demo invite_qr voice_idle
...
for fixture in $fixtures; do
  ...
  "$ADB_BIN" -s "$ANDROID_SERIAL" shell screencap -p "$remote"
