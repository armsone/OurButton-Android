...
- Parent and child voice recording starts from the `소리` home action, asks for confirmation before sending, plays once when the recipient enters the app, and remains replayable from call history.
