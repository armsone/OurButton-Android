...
- Parent voice recording starts directly on the home action while it is held, sends on release, plays once when the recipient enters the app, and remains replayable from call history.
